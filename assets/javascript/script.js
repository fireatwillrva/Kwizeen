...
// template literal to create the html
           var recipeHTML = `<div class = recipeDiv><img class = "recipeImg" src =${recipeImage}><br><a class = "recipeLink" href =${recipeLink}>${recipeTitle}</a><br><button class = "addList btn btn-secondary" id = "${i}">Add to List</button><button class = "addBook btn btn-secondary" id = "${i}">Add to book</button></div>`
